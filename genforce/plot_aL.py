...
def main():
    acc_0 = np.genfromtxt('models/pretrain/0_cos_1e-6_adversarial_loss.csv', delimiter=',')
    acc_c = np.genfromtxt('models/pretrain/1e3_cos_1e-5_adversarial_loss.csv', delimiter=',')
    acc_inf = np.genfromtxt('models/pretrain/inf_cos_1e-4_adversarial_loss.csv', delimiter=',')
